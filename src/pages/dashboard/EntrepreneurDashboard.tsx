...
import { Users, Bell, Calendar, TrendingUp, Wallet, AlertCircle, PlusCircle } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link to="/meetings" className="block">
          <Card className="bg-accent-50 border border-accent-100 hover:bg-accent-100 transition-colors">
            <CardBody>
              <div className="flex items-center">
            ...
            <CardBody>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-semibold text-success-900">${walletBalance.toLocaleString()}</h3>
                </div>
              </div>
            </CardBody>
          </Card>
